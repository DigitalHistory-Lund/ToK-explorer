...
with sqlite3.connect(rel_db) as conn:
    ...
    lines = [go.Line(x=x, y=y_uc, name='utterance count'),
             go.Line(x=x, y=y_k, name='kvinna'),
             go.Line(x=x, y=y_k1, name='kvinna1'),
             go.Line(x=x, y=y_k2, name='kvinna2'),
             go.Line(x=x, y=y_k3, name='kvinna3'),
            ]
    pyo.iplot({
        'data':lines,
                    'layout':{
...
with sqlite3.connect(rel_db) as conn:
    ...
    lines = [
            go.Line(x=x, y=y_uc, name='word count'),
             go.Line(x=x, y=y_k, name='kvinna'),
             go.Line(x=x, y=y_k1, name='kvinna1'),
             go.Line(x=x, y=y_k2, name='kvinna2'),
             go.Line(x=x, y=y_k3, name='kvinna3'),
    ...
    lines = [
             go.Line(x=x, y=y_kr, name='kvinna'),
             go.Line(x=x, y=y_k1r, name='kvinna1'),
             go.Line(x=x, y=y_k2r, name='kvinna2'),
             go.Line(x=x, y=y_k3r, name='kvinna3'),
            ]
    pyo.iplot({
        'data':lines,
                              'layout':{
...
with sqlite3.connect(rel_db) as conn:
    ...
    for gender, data in by_gender.items():
        ...
        lines += [
              go.Line(x=x, y=y_uc, name=f'{gender}: word count'),
              go.Line(x=x, y=y_k, name=f'{gender}: kvinna'),
              go.Line(x=x, y=y_k1, name=f'{gender}: kvinna1'),
              go.Line(x=x, y=y_k2, name=f'{gender}: kvinna2'),
              go.Line(x=x, y=y_k3, name=f'{gender}: kvinna3'),
              ]

        relines += [
              go.Line(x=x, y=y_kr, name=f'{gender}: kvinna'),
              go.Line(x=x, y=y_k1r, name=f'{gender}: kvinna1'),
              go.Line(x=x, y=y_k2r, name=f'{gender}: kvinna2'),
              go.Line(x=x, y=y_k3r, name=f'{gender}: kvinna3'),
              ]
...
with sqlite3.connect(rel_db) as conn:
    ...
    for party, data in by_party.items():
        ...
        k.append(go.Line(x=x, y=y_kr, name=f'{party}'),)
        k1.append(go.Line(x=x, y=y_k1r, name=f'{party}'),)
        k2.append(go.Line(x=x, y=y_k2r, name=f'{party}'),)
        k3.append(go.Line(x=x, y=y_k3r, name=f'{party}'),)
